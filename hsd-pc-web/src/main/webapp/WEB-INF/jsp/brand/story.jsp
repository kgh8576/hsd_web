...
<div class="content brand">
    ...
    <section class="brand_story">
        ...
        <div class="bs_wrap section_02">
            <div class="bs_cont">
                <div class="bs_img mo_tr">
                    <img src="${cp}/assets/images/brand/brand_img_01.jpg" alt="갓 지은 한끼 이미지" />
                </div>
        ...
        <div class="bs_wrap section_03">
            <div class="bs_cont">
                <div class="bs_img mo_tr">
                    <img src="${cp}/assets/images/brand/brand_img_02.jpg" alt="변함없이 한결같은 한솥 이미지" />
                </div>
                <div class="bs_txt_wrap">
                    <h3 class="h3_tit fz_01">
                    ...
                    <div class="btn_wrap btn_more">
                        <span class="btn btn_st04">
                            <a href="${cp}/hansot/social" class="c_05">사회공헌활동</a>
                        </span>
                    </div>
                    <!-- //btn -->
                </div>
        ...
        <div class="bs_wrap section_04">
            <div class="bs_cont mo_tr">
                <div class="bs_txt_wrap">
                    ...
                    <!-- btn -->
                    <%--<div class="btn_wrap">--%>
                        <%--<span class="btn btn_st04"><a href="${cp}/brand/bi" class="c_06">New BI소개</a></span>--%>
                    <%--</div>--%>
                    <!-- //btn -->
                </div>
            </div>
