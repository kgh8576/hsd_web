...
<div class="content brand">
    ...
    <section class="brand_philosophy">
        ...
        <div class="bs_wrap section_02">
            <div class="bs_cont">
                <div class="bs_img mo_tr">
                    <img src="${cp}/assets/images/brand/brand_ph_img_01.jpg" alt="한솥밥 이미지" />
                </div>
        ...
        <div class="bs_wrap section_03">
            <div class="bs_cont">
                <div class="bs_img mo_tr">
                    <img src="${cp}/assets/images/brand/brand_ph_img_02.jpg" alt="한솥밥 이미지" />
                </div>
                <div class="bs_txt_wrap">
                    <h3 class="h3_tit fz_01">
        ...
        <div class="bs_wrap section_04">
            <div class="bs_cont mo_tr">
                <div class="bs_img mo_tr">
                    <img src="${cp}/assets/images/brand/brand_ph_img_03.jpg" alt="한솥밥 이미지" />
                </div>
                <div class="bs_txt_wrap">
                    <h3 class="h3_tit fz_01">
                    ...
                    <div class="btn_wrap">
                        <span class="btn btn_st04">
                            <a href="${cp}/menu/material" class="c_05">식재료 이야기</a>
                        </span>
                    </div>
                    <!-- //btn -->
                </div>
