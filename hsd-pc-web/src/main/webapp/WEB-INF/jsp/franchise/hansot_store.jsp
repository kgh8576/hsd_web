        ...
        <div class="hs_wrap section_02">
            <div class="hs_cont">
                <div class="hs_img mo_tr">
                    <img src="${cp}/assets/images/franchise/fr_img_01.jpg" alt="한솥이어야 하는 세가지 이유 이미지" />
                </div>
        ...
        <div class="hs_wrap section_03">
            <div class="hs_cont">
                <div class="hs_txt_wrap">
                    ...
                    <div class="hs_txt h3">
                        <h3 class="h3_tit fz_01">
                            <span class="s_block">27년 노하우로 지원해 드립니다.</span>
                        </h3>
                        <p>
                    ...
                    <div class="hs_txt hs_03">
                        ...
                        <p>
                            <span class="s_block">매월 신메뉴 출시 및 행사때마다 전 점포에 접지 전단지(400매),</span>
                            <span class="s_block">신규 및 양도양수 오픈 점포의 경우 행사전단지(4,000매),</span>
                            <span class="s_block">자석전단(1,000매)를 제작하여 무상지원 해드립니다.</span>
                        </p>
                    </div>
                    <!-- //list_03 -->
                    <!-- list_04 -->
