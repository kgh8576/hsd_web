...
<div class="content franchise success">
    <section class="success_list">
        ...
        <div class="suc_wrap tab_st01">
            <div class="ontitle">
                <h2 class="h2_tit h2_02 mo_version">공모전 수상작</h2>
                <div class="tab_wrap mo_version">
                    <ul class="tab_menu">
                        <li><a href="${cp}/franchise/success">성공 수기</a></li>
                        <li class="active"><a href="#none">공모전 수상작</a></li>
                    </ul>
                </div>
            </div>
            <div class="suc_cont">
                            ...
                            <div class="suc_list_cnt">
                                ...
                                <div class="btn_wrap">
                                    <span class="btn btn_st04">
                                        <a href="${cp}/franchise/winner_view/${data.idx}" class="c_07">상세보기</a>
                                    </span>
                                </div>
                                <!-- //버튼 -->
                                <!-- border_bg -->
