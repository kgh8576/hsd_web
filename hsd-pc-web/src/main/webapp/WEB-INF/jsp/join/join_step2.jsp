<html>
<head>
    <title>한솥도시락 > 회원가입 > 02.본인인증</title>
        ...
        <div class="join_step_wrap">
            ...
            <div class="join_step_cont cont_st01">
                ...
                <div class="join_tit">
                    ...
                    <p class="pa_01">
                        <span class="s_block">휴대폰 인증을 통하여 <em class="emphasis">가입 확인 및</em></span>
                ...
                <div class="join_sub">
                    ...
                    <div class="join_certi_wrap">
                        <div class="join_certi">
                            <span><a href="javascript:fnAuthMobile();">휴대폰 인증</a></span>
                        </div>
                    </div>
                </div>
                <!-- //join_right -->

                <form:form id="authForm" name="authForm" type="post" action="${cp}/join/join_step3">
                    ...
                    <input type="hidden" id="agree_use" name="agree_use" value="${agree_use}" />
                    <input type="hidden" id="agree_personal" name="agree_personal" value="${agree_personal}" />
                    <input type="hidden" id="agree_3rd" name="agree_3rd" value="${agree_3rd}" />
                </form:form>
            </div>
        </div>
        <!-- //회원가입_약관동의 -->
