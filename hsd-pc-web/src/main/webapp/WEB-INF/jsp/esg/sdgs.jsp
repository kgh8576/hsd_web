...
<div class="content brand">
    ...
    <section class="brand_sdgs">
        ...
        <div class="bs_wrap section_01">
            <p class="menu_tit mo_version">SDGs</p>
            <div class="bs_cont mo_tr">
                <h2 class="h2_tit">글로벌 지속가능 브랜드 40 선정</h2>
                <div class="bs_txt" style="float: none;">
                    <p>
                        ESG(환경보호, 사회공헌, 윤리경영)경영을 추구해왔던 한솥도시락이 그 공적을 인정받아
                        <strong>'UN지원SDGs협회 글로벌 지속가능 브랜드 40'</strong>에 선정되었습니다.
                    </p>
                    <p>
                        국내 프랜차이즈 업계 중 최초로 유엔 지속가능개발목표(SDGs) 파트너쉽 홈페이지에 소개된
                        한솥도시락은 앞으로도 ESG경영을 통하여 <strong>'따끈한 도시락으로 지역사회에 공헌한다'</strong>는
                        기업이념을 지속적으로 실천해 나가겠습니다.
                    </p>
                    <p>
                    </p>
                </div>
