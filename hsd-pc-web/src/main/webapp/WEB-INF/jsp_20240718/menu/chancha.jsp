...
<div class="content menu list">
    ...
    <section class="menu_chancha">
        ...
        <div class="mat_section section_02">
            <div class="mat_cont">
                <div class="mat_img mo_tr">
                    <img src="${cp}/assets/images/menu/chancha_img_01.jpg" alt="페루 찬차마요 커피와 한솥의 인연" />
                </div>
                <div class="mat_txt_wrap">
                    ...
                    <div class="mat_txt">
                        ...
                        <div class="chancha_link">
                            <a href="https://youtu.be/ck-NVmqO1Kw" title="새 창 열림" target="_blank"><img src="${cp}/assets/images/menu/chancha_img_02.jpg" alt="페류 아마존의 한인시장 정흥원 편" /></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mat_section section_03">
            <div class="mat_cont">
                <div class="mat_img mo_tr">
                    <img src="${cp}/assets/images/menu/chancha_img_03.jpg" alt="남미 최고 품질의 천연 자연 재배 커피" />
                </div>
                <div class="mat_txt_wrap">
                    <h3 class="h3_tit fz_01">
                ...
                <div class="mat_img_box">
                    <p>
                        <img src="${cp}/assets/images/menu/chancha_img_04.jpg" alt="최상등급 커피">
                        <span>
                            <em>최상등급 천연 생두만 사용</em>
                        </span>
                    </p>
                    <p>
                        <img src="${cp}/assets/images/menu/chancha_img_05.jpg" alt="핸드픽킹 방식의 수확">
                        <span>
        ...
        <div class="mat_section section_04">
            <div class="mat_cont">
                <div class="mat_img mo_tr">
                    <img src="${cp}/assets/images/menu/chancha_img_06.jpg" alt="영세 농민들을 위해 공정한 직접무역 진행" />
                </div>
                <div class="mat_txt_wrap">
                    <h3 class="h3_tit fz_01">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.mat_cont ').addClass("hidden").viewportChecker({
