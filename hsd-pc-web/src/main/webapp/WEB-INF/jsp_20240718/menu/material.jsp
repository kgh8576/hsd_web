...
<div class="content menu list">
    ...
    <section class="menu_material">
        ...
        <div class="mat_section section_02">
            <div class="mat_cont">
                <div class="mat_img mo_tr">
                    <img src="${cp}/assets/images/menu/material_img_01.jpg" alt="김치이야기 이미지1" />
                </div>
                <div class="mat_txt_wrap">
                    <h3 class="h3_tit fz_01">
                        <em class="emphasis">김치 이야기</em>
                        <span class="s_block"><em class="ma_f">100</em>% 국산 김치</span>
                    </h3>
                    <div class="mat_txt">
                        <p>
                            <span class="s_block">땅 좋고 물좋은 해남, 평창, 태백에서 재배한 배추에</span>
                            <span class="s_block">국산 고춧가루와 마늘, 젓갈 등 우리 농산물만 오롯이 사용하여</span>
                            <span class="s_block">한솥김치를 만들었습니다.</span>
                        </p>
                        <span class="mat_seimg"><img src="${cp}/assets/images/menu/material_img_02.jpg" alt="김치이야기 이야기2" /></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="mat_txt_wrap">
                    ...
                    <div class="mat_txt">
                        <p>
                            ...
                            <span class="s_block">테스트를 통해 수분, 단백질, 아밀로스 햠량을</span>
        ...
        <div class="mat_section section_03">
            <div class="mat_cont">
                <div class="mat_img mo_tr">
                    <img src="${cp}/assets/images/menu/material_img_03.jpg" alt="고기이야기 이미지" />
                </div>
                <div class="mat_txt_wrap">
                    <h3 class="h3_tit fz_01">
