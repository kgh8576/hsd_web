    ...
    <section class="brand_legacy">
            ...
            <div class="bs_cont mo_tr">
                ...
                <div class="bs_txt">
                    <p>
                        ...
                        <span class="s_block">한솥의 발자국들. 지난 27년 동안 한결 같은 마음으로 고객을 위해 성장하고 있는, </span>
        ...
        <div class="bs_wrap section_02">
            <div class="bs_cont">
                <figure class="lg_wrap">
                    <span class="g_visual">
                        <img src="${cp}/assets/images/brand/bg_legacy_01.png" alt="지구 50바퀴">
                    </span>
                    <figcaption>
                        <h3 class="h3_tit">
        ...
        <div class="bs_wrap section_03">
            <div class="bs_cont">
                <figure class="lg_wrap">
                    <span class="g_visual">
                        <img src="${cp}/assets/images/brand/bg_legacy_02.png" alt="온 국민이 3그릇 씩">
                    </span>
                    <figcaption>
                        <h3 class="h3_tit">
        ...
        <div class="bs_wrap section_04">
            <div class="bs_cont">
                <figure class="lg_wrap">
                    <span class="g_visual">
                        <img src="${cp}/assets/images/brand/bg_legacy_03.png" alt="3년 2개월">
                    </span>
                    <figcaption>
                        <h3 class="h3_tit">
        ...
        <div class="bs_wrap section_05">
            <div class="bs_cont">
                <figure class="lg_wrap">
                    <span class="g_visual">
                        <img src="${cp}/assets/images/brand/bg_legacy_04.png" alt="200여종의 메뉴 출시">
                    </span>
                    <figcaption>
                        <h3 class="h3_tit">
