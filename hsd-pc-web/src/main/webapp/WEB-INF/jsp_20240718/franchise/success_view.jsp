...
<div class="content franchise success">
    <section class="success_view mo_version">
        ...
        <div class="suc_wrap">
            <!-- title -->
            <h2 class="h2_tit h2_01"><a href="#none" onclick="goList();return false;">성공 수기</a></h2>
            <!-- //title -->
            <!-- 성공수기 cont -->
            <div class="suc_view_wrap cont_st02">
                ...
                <div class="area_cont">
                    <div class="view_txt pa_02">
                        <img style="height: auto;" src="${result.thumImg}" alt="${result.storeName}" />
                        ${result.contents}
                    </div>
                    <!-- area btn-->
...
<script type="text/javascript">
    // 목록이동
    function goList(){
        location.href = "${cp}/franchise/success";
    }

    // 이전글, 다음글
    function goView(idx){
        location.href = "${cp}/franchise/success_view/"+idx;
    }
</script>
</body>
</html>
